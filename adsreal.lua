_G.Settings = {
    ...
    RaidName = ""; -- Esper Raid; Tengoku Raid; Titan Raid; Hirito Raid; Gear 5 Fluffy Raid; Black Pasta Raid; Cosmic Wolfman Raid; 
...
Map_table = {
    "Titan Dimension", "Demon Dimension", "Curse Dimension", "Villain Dimension", "Sword Dimension", "Ghoul Dimension", "Fate Dimension", "Slime Dimension", "Devil Dimension", "Pirate Dimension", "Alien Dimension"
}
Diff_table = {
    "Easy", "Hard", "Nightmare"
}
...
function DimensionCheck(level)
    ...
    -- Slime Dimensions
    if level >= 113 and level <= 120 then
